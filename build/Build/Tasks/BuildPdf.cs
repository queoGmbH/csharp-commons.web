...
{
    /// <summary>
    /// Task for generating PDF documentation from AsciiDoc files.
    ...
    /// </summary>
    [TaskName("BuildPdf")]
    public class BuildPdf : FrostingTask<Context>
    {
        /// <summary>
        /// Runs the task to generate PDF documentation from AsciiDoc files.
        /// </summary>
        /// <param name="context"></param>
        public override void Run(Context context)
        {
            // AsciiDoctor is a Ruby gem that converts AsciiDoc files to PDF.
            // It needs to be installed on the machine to generate PDF documentation.
            ...
            else
            {
                ...
                @"powershell",
                $@"asciidoctor -r asciidoctor-pdf -r asciidoctor-diagram -b pdf {rootFilePath} -o {generatedPath}{Path.DirectorySeparatorChar}{name}.pdf");
                process?.WaitForExit();
            }
        }
